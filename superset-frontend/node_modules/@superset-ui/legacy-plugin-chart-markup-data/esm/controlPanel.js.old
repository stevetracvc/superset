...
import { QueryMode, smartDateFormatter, t } from '@superset-ui/core';
import { formatSelectOptions, ColumnOption, D3_TIME_FORMAT_OPTIONS, QueryModeLabel } from '@superset-ui/chart-controls';
...
function getQueryMode(controls) {
  var _controls$query_mode, _controls$all_columns, _ref;
  ...
  const hasRawColumns = rawColumns && ((_ref = rawColumns) == null ? void 0 : _ref.length) > 0;
...
const all_columns = {
  ...
  default: [],
  optionRenderer: c => /*#__PURE__*/_react.default.createElement(ColumnOption, {
    showType: true,
    column: c
  }),
  valueRenderer: c => /*#__PURE__*/_react.default.createElement(ColumnOption, {
    column: c
  }),
